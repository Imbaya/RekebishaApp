...
import Coke from "../assets/Fries.jpeg";
    ...
    const renderOfferItem = ({ item }) => (
        ...
        <View style={{ width: '100%', paddingHorizontal: 10 }}>
            <TouchableOpacity onPress={() => {
                navigation.navigate("DotDotOfferCart",
                    { productId: item.id })
            }} 
            >
            ...
            <Card style={styles.Product}>
                ...
                <View style={styles.buyView}>
                    ...
                    <View style={styles.BuyView}>
                        ...
                        <TouchableOpacity   /* onPress={() => {
                            navigation.navigate("DotDotCart",
                                { productId: item.id })
                        }} */
        ...
        <View style={styles.container}>
            ...
            >
                        ...
                        <View style={styles.back}>
                            ...
                            >
                                <Icon
                                    ...
                                    color="white"
                                    size={35}
                                    onPress={() => { navigation.navigate("HustlerList", { state: 0 }) }}
                                />
                ...
                <View style={styles.textView}>
                    <TitleText style={styles.Text}>Kibandaski Menu</TitleText>
                ...
                <TitleText style={styles.offerText}>Fast Food</TitleText>
                ...
                <TitleText style={styles.offerText}>Quick serve</TitleText>
                <View style={styles.flat}>
...
/>
                ...
                <View style={styles.cartButton}>
                    <TouchableOpacity onPress={() => { navigation.navigate("HustlerCart", { cartItems }) }}>

                        <Card style={styles.cartbutton}>
...
<TitleText style={styles.cartbuttonText}>View Cart</TitleText>


</View>
         <View>                
<TitleText style={styles.cartbuttonText1}>{totalItems}</TitleText>                      
</View>
