...
const DotDotOfferCart = ({ navigation, route }) => {
    ...
    */}
    ...
    {/*const BuyDotDotProduct = async () => {
        ...
        try {
            ...
            const products = [
                {
                    name: name, // Replace 'Product Name 1' with the actual product name variable
                    quantity: quantity, // Replace 'quantity' with the actual quantity variable
                    price: price, // Replace 'price' with the actual price variable
                    imgUrl: imgUrl, // Replace 'imgUrl' with the actual imgUrl variable
                    category:category
                },
            ];
                    ...
                    <View style={styles.description}>
                        ...
                        <View style={styles.textView}>
                            ...
                            <View style={styles.textView2}>
                                ...
                                <Text allowFontScaling={false} style={styles.text421}>{category}</Text>
...
/> */}
                            ...
                            <Text allowFontScaling={false} style={styles.text2e21}>Ksh {price} </Text>
...
export default DotDotOfferCart;